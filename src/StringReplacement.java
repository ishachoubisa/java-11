public class StringReplacement {
    public static void main(String[] args) {
        ...
        resultArray[1] = "Replace literal \"iss\" with \"ips\" : "+mississippi.replace("iss","ips");
        resultArray[2] = "Replace regexp[i with 2 characters(s or p)] with literals \"ax\": "+mississippi.replaceAll("(i(s|p){2})","ax");
        resultArray[3] = "Replace first match of regexp[i with 2 characters(s or p)]  "+"with literals \"ax\": "+mississippi.replaceFirst("(i(s|p){2})","ax");
