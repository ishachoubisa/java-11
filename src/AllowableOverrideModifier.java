...
class Employee{
    ...
    private void printPrivate(){
        System.out.println("An Employee can make a private statement, "+ "but only the employee can make it accessible through "+ "other means..");
    }
    protected void blog(){
        printPrivate();
    }
...
class Boss extends Employee {
    ...
    protected void printPackage(){
        System.out.println("A Boss package speech can "+ "be share with his children now.");
    }
//    private void printPublic(){
//        System.out.println("A Boss's public speech cannot be made private");
//    }
//    void printProtected(){
//        System.out.println("A Boss's protected speech cannot be package");
//    }
}

public class AllowableOverrideModifier {
