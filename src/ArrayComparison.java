...
public class ArrayComparison {
    public static void main(String[] args) {
        ...
        System.out.println("---------More Arrays.compare-----------");
        System.out.println("(Arrays.compare(firstString,firstStringUnsorted)) = "+Arrays.compare(firstString,firstStringUnsorted));
        System.out.println("firstString[0].compareTo(firstStringUnsorted[0]) = "+firstString[0].compareTo(firstStringUnsorted[0]));

        String[] notFullyPrefixedString = {"abc","def","ghi","yz","vwx","stu"};
        System.out.println("(Arrays.compare(firstString,notFullyPrefixedString)) = "+Arrays.compare(firstString,notFullyPrefixedString));
        System.out.println("firstString[3].compareTo(notFullyPrefixedString[3]) = "+firstString[3].compareTo(notFullyPrefixedString[3]));


        System.out.println("----------Arrays.compare for Element Ranges--------");

        String[] stringArray = {"abc","def","ghi","jkl","mno","pqr","stu","vwx","yz"};

        String[] stringUnsortedArray = {"jkl","mno","pqr","stu","vwx","yz","abc","def","ghi"};

        System.out.println("(Array.compare(stringArray,0,3,stringUnsortedArray,6,9)) = "+Arrays.compare(stringArray,0,3,stringUnsortedArray,6,9));
        System.out.println("(Array.compare(stringArray,0,5,stringUnsortedArray,6,9)) = "+Arrays.compare(stringArray,0,5,stringUnsortedArray,6,9));
